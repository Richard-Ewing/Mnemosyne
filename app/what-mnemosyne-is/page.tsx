...
export default function WhatMnemosyneIs() {
    return (
            ...
            <section className="relative z-10 section max-w-7xl mx-auto px-6 pt-24 md:pt-32">
                <BlurIn className="text-center max-w-4xl mx-auto">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-8 leading-tight">
                        What <SparklesText className="gradient-text">Mnemosyne</SparklesText> Is
                    </h1>
                    <p className="text-xl md:text-2xl text-gray-200 leading-relaxed">
                        Mnemosyne is a <span className="text-white font-semibold">model-agnostic semantic ledger</span> that
                    ...
                    <BorderBeam>
                        <div className="p-8 md:p-12 text-center">
                            <p className="text-lg text-gray-300 mb-6">
                                Instead of storing conversations or prompts, Mnemosyne maintains a ledger of
                            ...
                            <div className="flex flex-col gap-2 text-lg">
                                ...
                                <p className="font-semibold">
                                    <AnimatedGradientText className="text-xl">Mnemosyne speaks meaning.</AnimatedGradientText>
                                </p>
                            </div>
                        </div>
                    </BorderBeam>
                    ...
                    <AnimatedSection delay={0.1} animation="fade-left">
                        <GlowCard className="h-full">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-gray-100">What Mnemosyne Is</h2>
                            </div>
                    ...
                    <AnimatedSection delay={0.2} animation="fade-right">
                        <GlowCard className="h-full">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-gray-100">What Mnemosyne Is Not</h2>
                            </div>
                            <ul className="space-y-4">
                                {[
                                    "A chatbot",
