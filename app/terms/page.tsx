...
export const metadata: Metadata = {
    title: "Terms of Service | Mnemosyne",
    description:
        "Terms of Service for Mnemosyne Semantic Memory Governance Infrastructure.",
};
            ...
            <div className="prose prose-invert prose-lg max-w-none">
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        By accessing or using Mnemosyne (&quot;Service&quot;), you agree to be bound
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed mb-4">
                        Mnemosyne is a semantic memory governance infrastructure that
                        provides:
                    </p>
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed mb-4">
                        ...
                        all rights to content you store in Mnemosyne. By using the
